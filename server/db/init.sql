...
CREATE TABLE meeting_requests (
  ...
  -- status values (owned by Domain 3 logic):
  -- pending -> waiting_mentor_times -> waiting_mentee_choice -> matched
  -- -> attendance_confirmed -> occurred / not_occurred -> feedback_filled
  -- also: declined
